    ...
    <aside className="w-64 bg-white p-4 shadow-lg">
      ...
      <nav>
        ...
        <div>
          ...
          <button className="block w-full text-left py-2 px-4 hover:bg-gray-200 rounded">Kelola Data</button>
          <div className="pl-4 mt-2">
            <NavLink to="/admin/laporan/masuk" className="block py-1 px-2 hover:bg-gray-100 rounded">Mitra</NavLink>
            <NavLink to="/admin/laporan/diproses" className="block py-1 px-2 hover:bg-gray-100 rounded">Instansi</NavLink>
            <NavLink to="/admin/laporan/terealisasi" className="block py-1 px-2 hover:bg-gray-100 rounded">Pengguna</NavLink>
          </div>
        </div>
